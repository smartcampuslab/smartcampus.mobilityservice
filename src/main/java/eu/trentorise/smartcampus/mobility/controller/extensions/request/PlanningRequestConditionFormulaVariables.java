...
public class PlanningRequestConditionFormulaVariables {
	...
	public PlanningRequestConditionFormulaVariables() {
	}
	
	public PlanningRequestConditionFormulaVariables(PlanningRequest pr) {
		ttype = pr.getType();
