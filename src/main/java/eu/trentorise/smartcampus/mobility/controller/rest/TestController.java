...
//		Notification notification = notificatioManager.buildNotification("it", LevelGainedNotification.class.getSimpleName(), null);
//
//		if (title != null) {
...
//		}
//		
//		notificatioHelper.notify(notification, (id == null ? "33" : id), NOTIFICATION_APP);
//	}	
