...
//				}
	...
	public static ValidationStatus validateFreeWalk(Collection<Geolocation> track, List<Shape> areas) {
		...
		double speedThreshold = WALK_SPEED_THRESHOLD, timeThreshold = 10 * 1000, minTrackThreshold = 60*1000, avgSpeedThreshold = WALK_AVG_SPEED_THRESHOLD, guaranteedAvgSpeedThreshold = WALK_GUARANTEED_AVG_SPEED_THRESHOLD; 
